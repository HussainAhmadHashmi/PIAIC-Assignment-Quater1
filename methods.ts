...
// Numbers================================
const numbers:number= 1000000000 //25.5588
// console.log(numbers);
...
function loginUserMsg(username:string){
...
function returnSecondValue(getArray:any[]) {
    return getArray[1]
}
...
// iceteaPrice <= 80 ? console.log("less than 80"): console.log("grather than 80");
...
const programming: string[] = ["html", "css", "javaScript", "html", "css", "javaScript"];
...
const coding:string[]  = ["js", "ts", "java", "Ruby"]
...
const programs:number[] = [1,2,3,4,5,6,7,8,9]
